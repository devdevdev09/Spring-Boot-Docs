...
* The original package name 'com.spring.boot.rest.docs.spring-boot-rest-docs' is invalid and this project uses 'com.spring.boot.rest.docs.springbootrestdocs' instead.
